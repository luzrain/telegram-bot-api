 ...
 * If a message is part of a message album, then it can be edited only to an audio for audio albums, only to a document for document albums
 * and to a photo a live photo, or a video otherwise. When an inline message is edited, a new file can't be uploaded;
 ...
 * the edited Message is returned, otherwise True is returned. Note that business messages that were not sent by the bot and
